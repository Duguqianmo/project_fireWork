...
function createFireworkParticles(x, y, z) {
    const particleCount = 50; // 每次爆炸的粒子数量
    const colors = [
        new THREE.Color(0xFFD700), // 金色
        new THREE.Color(0xFF6B00), // 橙红色
        new THREE.Color(0xFF0043), // 红色
    ...
    for (let i = 0; i < particleCount; i++) {
        ...
        const speed = 0.3 + Math.random() * 0.4; // 速度
        ...
        fireworkParticles.push({
            ...
            vz: vz,
            life: 1.0, // 生命周期（0-1）
            decay: 0.01 + Math.random() * 0.02, // 衰减速度
...
function showCountdownNumber(num) {
    ...
    const shadows = {
        10: '0 0 30px rgba(0, 255, 255, 0.8), 0 0 60px rgba(0, 255, 255, 0.6), 0 0 90px rgba(0, 255, 255, 0.4)',
        9: '0 0 30px rgba(255, 0, 255, 0.8), 0 0 60px rgba(255, 0, 255, 0.6), 0 0 90px rgba(255, 0, 255, 0.4)',
        8: '0 0 30px rgba(0, 255, 0, 0.8), 0 0 60px rgba(0, 255, 0, 0.6), 0 0 90px rgba(0, 255, 0, 0.4)',
        7: '0 0 30px rgba(139, 0, 255, 0.8), 0 0 60px rgba(139, 0, 255, 0.6), 0 0 90px rgba(139, 0, 255, 0.4)',
        6: '0 0 30px rgba(255, 0, 255, 0.8), 0 0 60px rgba(255, 20, 147, 0.6), 0 0 90px rgba(255, 105, 180, 0.4)',
        5: '0 0 30px rgba(0, 255, 255, 0.8), 0 0 60px rgba(0, 206, 209, 0.6), 0 0 90px rgba(32, 178, 170, 0.4)',
        4: '0 0 30px rgba(255, 0, 255, 0.8), 0 0 60px rgba(139, 0, 255, 0.6), 0 0 90px rgba(75, 0, 130, 0.4)',
        3: '0 0 30px rgba(0, 255, 0, 0.8), 0 0 60px rgba(0, 255, 255, 0.6), 0 0 90px rgba(0, 128, 255, 0.4)',
        2: '0 0 30px rgba(255, 0, 255, 0.8), 0 0 60px rgba(255, 0, 204, 0.6), 0 0 90px rgba(255, 0, 128, 0.4)',
        1: '0 0 30px rgba(0, 255, 255, 0.8), 0 0 60px rgba(0, 255, 128, 0.6), 0 0 90px rgba(0, 255, 0, 0.4)',
    };
    ...
    // 触发动画
    setTimeout(() => {
        countdown3DNumberElement.style.animation = 'pulse 0.5s ease-in-out';
    }, 10);

    // 在数字位置创建烟花粒子（屏幕中心，z=0）
    const now = Date.now();
    if (now - lastFireworkTime > 100) { // 限制创建频率
        createFireworkParticles(0, 0, 0);
